...
public class PostchargeCheckActivity extends BaseActivity implements ApiCallback {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        listAdapter = new PrechargeCheckAdapter(this,ServiceLogicUtils.getCheckListByProcessIdAndCyCategoryId(ServiceLogicUtils.process_id_postcharge_check));
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0) {
                    ...
                    Intent intent = new Intent(PostchargeCheckActivity.this, CyListActivity.class);
        ...
        switch (view.getId()) {
            ...
            case R.id.start_scanner:
                if (CommonTools.isCameraCanUse()) {
                    Intent intent = new Intent(PostchargeCheckActivity.this, CaptureActivity.class);
            ...
            case R.id.submit:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PostchargeCheckActivity.this);
        ...
        if (api.equals("submitPostchargeCheckResult")) {
            ...
            if (datas != null && datas.size() > 0) {
                ...
                for (LinkedTreeMap data : datas) {
                    ...
                    if (Integer.valueOf(bean.getProcessId()) == ServiceLogicUtils.process_id_postcharge_check) {
                        new Thread(){
                            @Override
                            public void run() {
                                //在子线程中进行下载操作
