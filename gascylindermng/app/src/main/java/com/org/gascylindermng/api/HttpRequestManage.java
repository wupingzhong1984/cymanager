...
public class HttpRequestManage {
    ...
    private Interceptor headerInterceptor = new Interceptor() {
      ...
      //              .addHeader("Accept", "application/json")
                    .addHeader("qcmappversion", BuildConfig.VERSION_NAME)
...
//    }
    ...
    private static class HttpRequestManageHolder {
        private static HttpRequestManage networkManageTools = new HttpRequestManage();
    }

    public static HttpRequestManage getInstanc() {
